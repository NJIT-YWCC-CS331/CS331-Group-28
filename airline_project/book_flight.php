...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        // Generate a new ticket_number safely (simple approach for class)
        ...
        // If your ticket.passenger_id is NOT NULL, tell me and I’ll adjust.
        $passenger_id = NULL;
        ...
        // bind_param doesn't accept NULL for int directly unless using variables; use a workaround:
